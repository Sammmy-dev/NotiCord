  ...
  return (
    <div className='flex min-h-[800px] w-full max-w-[1200px] bg-discord-background text-white rounded-lg overflow-hidden shadow-xl'>
      ...
      <div className='hidden sm:flex w-[72px] bg-[#202225] py-3 flex-col items-center'>
        ...
        <div className='w-8 h-[12px] bg-discord-background rounded-full my-2'/>
        {
        [...Array(5)].map((_, i)=>{
            return(
              <div
      ...
      <div className='hidden md:flex w-60 bg-[#2f3136] flex-col'>
        ...
        <div className='flex-1 overflow-y-auto pt-2'>
          <div className='px-2 mb-4'>
            <div className='flex items-center text-sm px-2 py-1.5 rounded hover:bg-[#393c43] text-[#dcddde]'>
          ...
          <div className='px-2 mb-4'>
            <h3 className='text-xs font-semibold text-[#8e9297] px-2 mb-2 uppercase'>Direct Messages</h3>
            ...
            <div className='flex items-center px-2 py-1.5 rounded bg-[#393c43] text-white cursor-pointer'>
              ...
              />
              <span className='font-medium'>NotiCord</span>
            </div>
      ...
      <div className='flex-1 flex flex-col'>
        ...
        <div className='h-16 bg-[#36393f] flex items-center px-4 shadow-sm border-b border-[#202225]'>
          ...
          <div className='flex items-center'>
            ...
            <p className='font-semibold text-white'>NotiCord</p>
          </div>
        ...
        <div className="p-4">
          <div className="flex items-center bg-[#40444b] rounded-lg p-1">
            ...
            <input readOnly type="text" placeholder='NotiCord' className='flex-1 bg-transparent py-2.5 px-1 text-white placeholder-[#72767d] focus:outline-none cursor-not-allowed'/>
